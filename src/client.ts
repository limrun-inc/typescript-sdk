...
export class Limrun {
  ...
  constructor({
    ...
    apiKey = readEnv('LIM_API_KEY') ?? null,
    ...opts
  }: ClientOptions = {}) {
...
export declare namespace Limrun {
  ...
  export {
    ...
    type XcodeRunOptions as XcodeRunOptions,
    ...
    type XcodeInfo as XcodeInfo,
    type XcodeStatus as XcodeStatus,
    type XcodeSelectResult as XcodeSelectResult,
    type SandboxInfo as SandboxInfo,
