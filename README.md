...
```sh
npm install git+ssh://git@github.com:stainless-sdks/limrun-v1-typescript.git
```
...
1. Via the `LIMRUN_LOG` environment variable
...
```ts
client.androidInstances.create({
  // ...
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/limrun-v1-typescript/issues) with questions, bugs, or suggestions.
