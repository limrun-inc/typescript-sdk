...
import type { InstalledApp } from '@limrun/api/ios-client';

import type { LimrunMaestroClient, ShimServer, SimctlResult } from './types';
...
export async function createXcrunShim(): Promise<string> {
...
function simctlList(udid: string, simctlArgs: string[]): SimctlResult {
...
function unsupportedPathBearingCommand(command: string | undefined): SimctlResult | undefined {
